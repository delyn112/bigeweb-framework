...
ini_set('upload_max_filesize', '800M');       // Set maximum upload file size to 800MB
ini_set('post_max_size', '800M');              // Set max post size to 800MB
ini_set('max_execution_time', '2000');         // Set max execution time to 2000 seconds
