...
define('COOKIE_LIFETIME', \illuminate\Support\Facades\BaseControllerFacades::cookies_time());
...
$user_mail = 'developer@bigeweb.com';
...
ini_set('session.save_path', asset('storage/framework/session'));
